...
-- In Neovim 0.12+, nvim-treesitter only installs parsers/queries; Neovim handles highlighting.
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sm', builtin.marks, { desc = '[S]each [M]arks' })
  ...
  { -- Parser/query installer for Neovim 0.12+ (highlighting is handled natively by Neovim)
  ...
  settings = {
    python = {
      analysis = {
        ...
        useLibraryCodeForTypes = false, -- Disable type inference from library code
      },
    },
  },
}
